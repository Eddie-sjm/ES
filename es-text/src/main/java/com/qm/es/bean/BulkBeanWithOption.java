 ...
 * @Author jackiechan
 */
public class BulkBeanWithOption extends BulkBean {
    private String json;
    private BulkOption bulkOption;
    ...
    public BulkOption getBulkOption() {
        return bulkOption;
    }

    public void setBulkOption(BulkOption bulkOption) {
